...
public class PetStoreExample {
     ...
     * and remove items from a shopping cart before doing a checkout upon doing a
    ...
    public static class PetStoreUI extends JPanel {
        ...
        public PetStoreUI(Vector<Product> items,
            ...
            //Create output area, embed in scroll area an add to bottomHalf parent
        ...
        /**
         * Calls the referenced callback, passing a the JFrame and selected items.
         */
     ...
     * we have two columns, both columns point to the same object. We user a
     * different renderer to display the different information about the object -
     * name and price.
     */
